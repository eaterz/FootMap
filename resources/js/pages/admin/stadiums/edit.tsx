...
export default function Edit({ stadium, countries }: Props) {
    const { data, setData, post, processing, errors } = useForm({
        name: stadium.name || '',
        country_id: stadium.country_id.toString() || '',
        city: stadium.city || '',
        latitude: stadium.latitude || '51.5074',
        longitude: stadium.longitude || '-0.1278',
    ...
    const [imagePreview, setImagePreview] = useState<string | null>(
        stadium.image ? `/storage/${stadium.image}` : null
    );
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(`/admin/stadiums/${stadium.id}`);
    };

    return (
        <>
            <Head title={`Edit ${stadium.name}`} />
            ...
            <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-950 p-6">
                <div className="mx-auto max-w-5xl">
                    ...
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Edit Stadium</h1>
                        <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">Update stadium information</p>
                    </div>
                                        ...
                                        {imagePreview ? (
                                            ...
                                            <div className="flex flex-col items-center">
                                                ...
                                                >
                                                    ...
                                                    {stadium.image ? 'Change Stadium Image' : 'Upload Stadium Image'}
                                                </label>
